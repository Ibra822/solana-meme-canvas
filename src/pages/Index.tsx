    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1A1F2C] to-[#2D243F]">
      <div className="container mx-auto px-4 h-screen flex flex-col">
        <header className="py-1">
          <h1 className="text-base md:text-lg font-bold bg-gradient-to-r from-solana-purple to-solana-blue bg-clip-text text-transparent font-['Press_Start_2P'] leading-relaxed">
            The Million Solana Memepage
          </h1>
          <p className="text-xs text-[#9b87f5] max-w-2xl mx-auto font-space">
