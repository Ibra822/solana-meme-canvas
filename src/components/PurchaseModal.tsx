  ...
  return (
    <>
        ...
        <DialogContent className="sm:max-w-[600px] bg-gradient-to-b from-[#1A1F2C] to-[#2D243F] text-white border border-solana-purple/20">
          ...
          <div className="grid gap-3 py-3">
            <div className="space-y-1.5">
              <Label htmlFor="image" className="text-white font-pixel text-[12px] flex items-center gap-2">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="solscan" className="text-white font-pixel text-[12px] flex items-center gap-2">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="hash" className="text-white font-pixel text-[12px] flex items-center gap-2">
      ...
      <Dialog open={showPixelSelector} onOpenChange={setShowPixelSelector}>
        <DialogContent className="sm:max-w-[800px] bg-gradient-to-b from-[#1A1F2C] to-[#2D243F] text-white border border-solana-purple/20">
          <DialogHeader>
            <DialogTitle className="text-xs font-pixel text-center bg-gradient-to-r from-[#FFD700] to-[#FFA500] bg-clip-text text-transparent pb-4">
              Select Pixel Blocks
            </DialogTitle>
